...
class BasicForceLayoutAlgorithmParametersTest {
    ...
    void testBuilder() {
        BasicForceLayoutParameters parameters = new BasicForceLayoutParameters.Builder()
                ...
                .withFriction(-3.4)
                .withMaxSpeed(107)
                .withRepulsionForceFromFixedPointsEnabled(false)
                .withAttractToCenterForceEnabled(false)
                .build();
        ...
        assertFalse(parameters.isRepulsionForceFromFixedPointsEnabled());
        assertFalse(parameters.isAttractToCenterForceEnabled());
    }
}
